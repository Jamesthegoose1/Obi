...
Obi is a usefull utility that when flashed onto a usb drive, can remotely run any powershell script on windows. As Obi evolves, it will support many other platforms.
